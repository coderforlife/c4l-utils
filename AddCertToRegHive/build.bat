...
i686-w64-mingw32-gcc %FLAGS% -o AddCertToRegHive.exe AddCertToRegHive.c -lCrypt32
echo.

echo Compiling 64-bit...
x86_64-w64-mingw32-gcc %FLAGS% -o AddCertToRegHive64.exe AddCertToRegHive.c -lCrypt32
pause
