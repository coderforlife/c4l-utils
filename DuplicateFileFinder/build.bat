...
set FILES=DuplicateFileFinder.c md5.c vector.c pair.c map.c 

echo Compiling 32-bit...
i686-w64-mingw32-gcc %FLAGS% -o DuplicateFileFinder.exe %FILES%
echo.

echo Compiling 64-bit...
x86_64-w64-mingw32-gcc %FLAGS% -o DuplicateFileFinder64.exe %FILES%
pause
