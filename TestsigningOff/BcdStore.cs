// Generated with: mgmtclassgen BcdStore /N root\WMI /O WMI /L CS
    ...
    public class BcdStore : System.ComponentModel.Component {
        ...
        public static bool ImportStoreWithFlags(string File, uint Flags) {
            ...
            if ((IsMethodStatic == true)) {
                ...
                inParams["File"] = ((System.String )(File));
                inParams["Flags"] = ((System.UInt32 )(Flags));
                System.Management.ManagementBaseObject outParams = classObj.InvokeMethod("ImportStoreWithFlags", inParams, null);
                return System.Convert.ToBoolean(outParams.Properties["ReturnValue"].Value);
            }
            else {
                return System.Convert.ToBoolean(0);
        ...
        public static bool SetSystemStoreDevice(string Partition) {
            ...
            if ((IsMethodStatic == true)) {
                ...
                inParams["Partition"] = ((System.String )(Partition));
                System.Management.ManagementBaseObject outParams = classObj.InvokeMethod("SetSystemStoreDevice", inParams, null);
                return System.Convert.ToBoolean(outParams.Properties["ReturnValue"].Value);
            }
            else {
                return System.Convert.ToBoolean(0);
